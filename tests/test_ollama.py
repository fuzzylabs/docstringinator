...
from docstringinator.providers import OllamaProvider
from docstringinator.models import DocstringInfo, DocstringFormat, LLMProvider
...
class TestOllamaProvider:
    ...
    @patch('requests.get')
    @patch('requests.post')
    def test_ollama_provider_initialisation(self, mock_post, mock_get):
    ...
    def test_ollama_generate_docstring(self, mock_post, mock_get):
        ...
        import asyncio
        response = asyncio.run(provider.generate_docstring(docstring_info, DocstringFormat.GOOGLE))
    ...
    def test_ollama_api_error(self, mock_post, mock_get):
        ...
        with pytest.raises(RuntimeError, match="Ollama API error"):
            asyncio.run(provider.generate_docstring(docstring_info, DocstringFormat.GOOGLE))
